...
class AndSpecificationTest extends AbstractTestCase
{
    ...
    public function testApplyToDoctrine(): void
    {
        ...
        $this->assertMatchesRegularExpression('/\ASELECT u FROM Ngmy\\\\Specification\\\\Test\\\\Stub\\\\Orm\\\\Doctrine\\\\User u WHERE u\.votes > :dcValue_[0-9]+_[0-9]+ AND u\.active = :dcValue_[0-9]+_[0-9]+\z/', $queryBuilder->getDQL());
