...
class AndSpecificationTest extends AbstractTestCase
{
    ...
    public function testApplyToDoctrine(): void
    {
        ...
        $this->assertSame('SELECT u FROM Ngmy\Specification\Test\Stub\Orm\Doctrine\User u WHERE u.votes > ?1 AND u.active = ?2', $queryBuilder->getDQL());
        $this->assertSame([1 => 100, 2 => 1], $this->getDoctrineParametersArray($queryBuilder));
    }
}
